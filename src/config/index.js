...
export const VEHICLE_NAVIGATION_SIMULATION_PITCH = 60;
export const PEDESTRIAN_NAVIGATION_SIMULATION_PITCH = 60;
export const SIMULATION_REPEAT_DELAY = 2000;

// Dimensions
export const TABLET_PANEL_WIDTH = 390;
export const TABLET_CHEVRON_BOTTOM_OFFSET = 100;
export const PHONE_CHEVRON_BOTTOM_OFFSET = 85;
