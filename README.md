...
| width | `number` | | The component width in pixels. |
| height | `number` | | The component height in pixels. |
...
| searchPosition | `string` possible values are "top" and "bottom"| "bottom" if the device is a phone, "top" if it's a tablet or desktop. | |
