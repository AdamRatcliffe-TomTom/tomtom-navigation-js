...
| routeOptions.travelMode                        | `string` possible values are "car", "truck", "taxi", "bus", "van", "motorcycle", "bicycle", "pedestrian" | "car"                                                                 | The travel mode used for the route calculation.                                                                                                                                                                                                         |
...
| renderETAPanel                      | `Function`                                                                                               |                                                                       | A render prop that can be used to render a custom ETA panel in place of the built-in panel e.g. ```
  renderETAPanel: ({
                    route,
                    measurementSystem,
                    isNavigating,
