...
| showTrafficFlow           | `boolean`                                                                                                           | `false`                  | Show the traffic flow layer.                                                                                                                                                                                                                            |
| showTrafficIncidents      | `boolean`                                                                                                           | `false`                  | Show the traffic incidents layer.                                                                                                                                                                                                                       |
| showPoi                   | `boolean`                                                                                                           | `false`                  | Show the POI layer.                                                                                                                                                                                                                                     |
...
| showLocationMarker        | `boolean`                                                                                                           | `true`                   | Show a location marker for the user's current location.                                                            |                           
| showMapSwitcherControl    | `boolean`                                                                                                           | `true`                   | Show the map style switcher control.                                                                                                                                                                                                                          |
| showMuteControl           | `boolean`                                                                                                           | `true`                   | Show the mute control.                                                                                                                                                                                                                                  |
| showSkipControl           | `boolean`                                                                                                           | `false`                   | Show a control for skipping to the route destination.                                                                                                                                                                                                                                  |
| showExitControl           | `boolean`                                                                                                           | `false`                   | Show a control for exiting the component.                                                                                                                                                                                                                                  |
| showZoomControl           | `boolean`                                                                                                           | `false`                   | Show the zoom control. This control, when enabled is not shown if the device is a phone due to space limitations.                                                                                                                                                                                                                                  |
...
| showManeuverArrows         | `boolean`                                                                                                           | `true`                   | Shows maneuver arrows along the route.                                                                                                                                                                                                                     |
...
| guidanceVoice             | `string`                                                                                                      |                          | The name of a text-to-speech voice provided by the Microsoft Speech Service. Available voices can be found [here](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/language-support?tabs=tts#standard-voices).                        |
...
| icon_offset_x | `number`      | No       | The horizontal offset in pixels to apply relative to the icon's center. A negative value indicates left.                                                                                                                  |
| icon_offset_y | `number`      | No       | The vertical offset in pixels to apply relative to the icon's center. A negative value indicates up.                                                                                                                      |
