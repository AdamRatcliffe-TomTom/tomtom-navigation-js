  ...
  implements ComponentFramework.ReactControl<IInputs, IOutputs>
{
  ...
  public updateView(
    ...
    const showNIP = this.getRawParameter(context, "showNIP");
    ...
    return [
      {
        ...
        coordinates: [-122.3118713, 37.5461359],
        name: "",
        address: "100 22nd Ave, San Mateo, CA 94403",
        icon: {
      ...
      },
      {
        ...
        coordinates: [-122.3003813, 37.5407896],
